// $ANTLR 3.3 Nov 30, 2010 12:50:56 ../MmirScriptBlock.g 2013-04-12 13:42:07
        ...
        try {
            ...
            switch (alt3) {
                case 1 :
                    ...
                    if(this.isDebug) printInfo('SCRIPT_BLOCK_comment',(COMMENT1?COMMENT1.getText():null));/*debug*/
                ...
                case 2 :
                    ...
                    if(this.isDebug) printInfo('SCRIPT_BLOCK_String' ,(STRING2?STRING2.getText():null));/*debug*/
                ...
                case 3 :
                    ...
                    if(this.isDebug) printInfo('SCRIPT_BLOCK_string' ,(SSTRING3?SSTRING3.getText():null));/*debug*/
