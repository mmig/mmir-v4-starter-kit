...
var buildSrcDir = '../../../build/lib/mmir-build/';
...
//	    }
	...
	, paths : {
	    ...
	    // lib
    , 'jquery': buildSrcDir+'jqueryDummy'//FIXME -> disabled by using a "dummy"...
 	, 'jqueryajax': buildSrcDir+'jqueryAjaxDummy'//FIXME -> "dummy" / replacement for $.ajax...
	...
	, 'env': buildSrcDir+'envDetectBuild'
//		, 'envInit': 'tools/envInit'
    ...
    , 'jqm': buildSrcDir+'jqueryMobileDummy'//FIXME -> disabled by using a "dummy"...
