function StatechartExecutionContext() {
    ...
    var $default_Regexp_N103C4 = /^($default)/,
        init_Regexp_N103C9 = /^(init)/,
        touch_end_on_login_btn_Regexp_N103CE = /^(touch_end_on_login_btn)/,
        touch_end_on_sign_up_btn_Regexp_N103D3 = /^(touch_end_on_sign_up_btn)/,
        touch_end_on_register_btn_Regexp_N103D8 = /^(touch_end_on_register_btn)/,
        back_Regexp_N103DD = /^(back)/,
        login_failed_Regexp_N103E2 = /^(login_failed)/,
        user_logged_in_Regexp_N103E7 = /^(user_logged_in)/,
        touch_end_on_appointment_btn_Regexp_N103EC = /^(touch_end_on_appointment_btn)/,
        touch_end_on_save_appointment_btn_Regexp_N103F1 = /^(touch_end_on_save_appointment_btn)/,
        touch_end_on_discard_appointment_btn_Regexp_N103F6 = /^(touch_end_on_discard_appointment_btn)/;
    //abstract state
    ...
    var main_state = (function() {
        function main_stateConstructor() {
            ...
            this.touch_end_on_login_btn = function() {
                return {
                    ...
                    action: function() {
                        ...
                        N10000_iterator++) {
                            var listener = listeners[N10000_iterator];
                            //transition id
                            listener.onTransition("", "login_user", "main_state_touch_end_on_login_btn_3");
                        }
                        //enter states
                ...
                return scxmlRoot['touch_end_on_login_btn']();
            }
            this.touch_end_on_sign_up_btn = function() {
                return {
                    preemptedBasicStates: {},
                    action: function() {
                        ...
                        N10000_iterator++) {
                            var listener = listeners[N10000_iterator];
                            //transition id
                            listener.onTransition("", "registration_form", "main_state_touch_end_on_sign_up_btn_4");
                        }
                        //enter states
                ...
                return scxmlRoot['touch_end_on_sign_up_btn']();
            }
            this.$dispatchPrefixEvent = function(e) {
                if (e.match(touch_end_on_login_btn_Regexp_N103CE)) {
                    return {
                        preemptedBasicStates: {},
                        action: function() {
                            //exit states
                            ...
                            N10000_iterator++) {
                                var listener = listeners[N10000_iterator];
                                //transition id
                                listener.onTransition("main_state", "login_user", "main_state_touch_end_on_login_btn_3");
                            }
                            //enter states
                            login_user.enterAction();
                            //update configuration
                ...
                if (e.match(touch_end_on_sign_up_btn_Regexp_N103D3)) {
                    return {
                        preemptedBasicStates: {},
                        action: function() {
                            //exit states
                            ...
                            N10000_iterator++) {
                                var listener = listeners[N10000_iterator];
                                //transition id
                                listener.onTransition("main_state", "registration_form", "main_state_touch_end_on_sign_up_btn_4");
                            }
                            //enter states
                            registration_form.enterAction();
                            //update configuration
    ...
    var registration_form = (function() {
        function registration_formConstructor() {
            ...
            this.exitAction = function() {
                for (var N10136_iterator = 0, N10136_hoist = listeners.length;
                N10136_iterator < N10136_hoist;
                N10136_iterator++) {
                    var listener = listeners[N10136_iterator];
                    //from
            ...
            this.touch_end_on_register_btn = function() {
                return {
                    ...
                    action: function() {
                        ...
                        N10000_iterator++) {
                            var listener = listeners[N10000_iterator];
                            //transition id
                            listener.onTransition("", "try_to_register_new_user", "registration_form_touch_end_on_register_btn_5");
                        }
                        //enter states
                ...
                return scxmlRoot['touch_end_on_register_btn']();
            }
            this.back = function() {
                return {
                    preemptedBasicStates: {},
            ...
            this.$dispatchPrefixEvent = function(e) {
                if (e.match(touch_end_on_register_btn_Regexp_N103D8)) {
                    return {
                        preemptedBasicStates: {},
                        action: function() {
                            //exit states
                            ...
                            N10000_iterator++) {
                                var listener = listeners[N10000_iterator];
                                //transition id
                                listener.onTransition("registration_form", "try_to_register_new_user", "registration_form_touch_end_on_register_btn_5");
                            }
                            //enter states
                            try_to_register_new_user.enterAction();
                            //update configuration
    ...
    var try_to_register_new_user = (function() {
        function try_to_register_new_userConstructor() {
            ...
            this.exitAction = function() {
                for (var N101D1_iterator = 0, N101D1_hoist = listeners.length;
                N101D1_iterator < N101D1_hoist;
                N101D1_iterator++) {
                    var listener = listeners[N101D1_iterator];
                    //from
    ...
    var login_user = (function() {
        function login_userConstructor() {
            ...
            this.exitAction = function() {
                for (var N10268_iterator = 0, N10268_hoist = listeners.length;
                N10268_iterator < N10268_hoist;
                N10268_iterator++) {
                    var listener = listeners[N10268_iterator];
                    //from
            ...
            this.$dispatchPrefixEvent = function(e) {
                if (e.match(login_failed_Regexp_N103E2)) {
                    return {
                        preemptedBasicStates: {},
                        action: function() {
                            //exit states
                ...
                if (e.match(user_logged_in_Regexp_N103E7)) {
                    if (mobileDS.User.getInstance() != null) return {
                        preemptedBasicStates: {},
                        action: function() {
                            //exit states
    ...
    var logged_in = (function() {
        function logged_inConstructor() {
            ...
            this.exitAction = function() {
                for (var N10344_iterator = 0, N10344_hoist = listeners.length;
                N10344_iterator < N10344_hoist;
                N10344_iterator++) {
                    var listener = listeners[N10344_iterator];
                    //from
            ...
            this.touch_end_on_appointment_btn = function() {
                return {
                    ...
                    action: function() {
                        ...
                        N10000_iterator++) {
                            var listener = listeners[N10000_iterator];
                            //transition id
                            listener.onTransition("", "create_appointment_initial", "logged_in_touch_end_on_appointment_btn_12");
                        }
                        //enter states
                ...
                return scxmlRoot['touch_end_on_appointment_btn']();
            }
            this.$dispatchPrefixEvent = function(e) {
                if (e.match(touch_end_on_appointment_btn_Regexp_N103EC)) {
                    return {
                        preemptedBasicStates: {},
                        action: function() {
                            //exit states
                            ...
                            N10000_iterator++) {
                                var listener = listeners[N10000_iterator];
                                //transition id
                                listener.onTransition("logged_in", "create_appointment_initial", "logged_in_touch_end_on_appointment_btn_12");
                            }
                            //enter states
                            create_appointment.enterAction();
                            create_appointment_initial.enterAction();
    ...
    var create_appointment = (function() {
        function create_appointmentConstructor() {
            ...
            this.exitAction = function() {
                for (var N103E5_iterator = 0, N103E5_hoist = listeners.length;
                N103E5_iterator < N103E5_hoist;
                N103E5_iterator++) {
                    var listener = listeners[N103E5_iterator];
                    //from
            ...
            this.touch_end_on_save_appointment_btn = function() {
                return {
                    ...
                    action: function() {
                        ...
                        N10000_iterator++) {
                            var listener = listeners[N10000_iterator];
                            //transition id
                            listener.onTransition("", "save_appointment", "create_appointment_touch_end_on_save_appointment_btn_14");
                        }
                        //enter states
                        create_appointment.enterAction();
                ...
                return scxmlRoot['touch_end_on_save_appointment_btn']();
            }
            this.touch_end_on_discard_appointment_btn = function() {
                return {
                    preemptedBasicStates: {},
                    action: function() {
                        ...
                        N10000_iterator++) {
                            var listener = listeners[N10000_iterator];
                            //transition id
                            listener.onTransition("", "logged_in", "create_appointment_touch_end_on_discard_appointment_btn_15");
                        }
                        //enter states
                        logged_in.enterAction();
                        //update configuration
                ...
                return scxmlRoot['touch_end_on_discard_appointment_btn']();
            }
            this.$dispatchPrefixEvent = function(e) {
                if (e.match(touch_end_on_save_appointment_btn_Regexp_N103F1)) {
                    return {
                        preemptedBasicStates: {},
                        action: function() {
                            //exit states
                            ...
                            N10000_iterator++) {
                                var listener = listeners[N10000_iterator];
                                //transition id
                                listener.onTransition("create_appointment", "save_appointment", "create_appointment_touch_end_on_save_appointment_btn_14");
                            }
                            //enter states
                            create_appointment.enterAction();
                            save_appointment.enterAction();
                ...
                if (e.match(touch_end_on_discard_appointment_btn_Regexp_N103F6)) {
                    return {
                        preemptedBasicStates: {},
                        action: function() {
                            //exit states
                            ...
                            N10000_iterator++) {
                                var listener = listeners[N10000_iterator];
                                //transition id
                                listener.onTransition("create_appointment", "logged_in", "create_appointment_touch_end_on_discard_appointment_btn_15");
                            }
                            //enter states
                            logged_in.enterAction();
                            //update configuration
    ...
    var create_appointment_initial = (function() {
        function create_appointment_initialConstructor() {
            ...
            this.exitAction = function() {
                for (var N103EA_iterator = 0, N103EA_hoist = listeners.length;
                N103EA_iterator < N103EA_hoist;
                N103EA_iterator++) {
                    var listener = listeners[N103EA_iterator];
                    //from
    ...
    var save_appointment = (function() {
        function save_appointmentConstructor() {
            ...
            this.exitAction = function() {
                for (var N1046F_iterator = 0, N1046F_hoist = listeners.length;
                N1046F_iterator < N1046F_hoist;
                N1046F_iterator++) {
                    var listener = listeners[N1046F_iterator];
                    //from
