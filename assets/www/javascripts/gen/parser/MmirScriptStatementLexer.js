...
org.antlr.lang.augmentObject(MmirScriptStatementLexer.prototype, {
    ...
    mT__30: function()  {
        try {
            ...
            // ../MmirScriptStatement.g:20:7: ( '{' )
            // ../MmirScriptStatement.g:20:9: '{'
            this.match('{'); 
    ...
    mT__31: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // ../MmirScriptStatement.g:21:7: ( '+' )
            // ../MmirScriptStatement.g:21:9: '+'
            this.match('+'); 
    ...
    mDoEnterStatement: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // ../MmirScriptStatement.g:123:2: ( '(' )
            // ../MmirScriptStatement.g:123:4: '('
            this.match('('); 
    ...
    mDoExitStatement: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // ../MmirScriptStatement.g:126:16: ( ')' )
            // ../MmirScriptStatement.g:126:19: ')'
            this.match(')'); 
        ...
        try {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // ../MmirScriptStatement.g:144:4: '\\r'
                    this.match('\r'); 


                    break;
                case 3 :
                    // ../MmirScriptStatement.g:145:4: '\\u2028'
                    this.match('\u2028'); 


                    break;
                case 4 :
                    // ../MmirScriptStatement.g:146:4: '\\u2029'
                    this.match('\u2029'); 
    ...
    mWS: function()  {
        try {
            var _type = this.WS;
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // ../MmirScriptStatement.g:151:5: ( ( ' ' | '\\t' | NL ) )
            // ../MmirScriptStatement.g:151:7: ( ' ' | '\\t' | NL )
            // ../MmirScriptStatement.g:151:7: ( ' ' | '\\t' | NL )
            var alt3=3;
            switch ( this.input.LA(1) ) {
            case ' ':
            ...
            switch (alt3) {
                case 1 :
                    // ../MmirScriptStatement.g:151:8: ' '
                    this.match(' '); 


                    break;
                case 2 :
                    // ../MmirScriptStatement.g:151:12: '\\t'
                    this.match('\t'); 


                    break;
                case 3 :
                    // ../MmirScriptStatement.g:151:18: NL
                    this.mNL(); 
    ...
    mCHAR: function()  {
        try {
            var _type = this.CHAR;
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // ../MmirScriptStatement.g:153:6: (~ ( '\\n' | '\\r' ) )
            // ../MmirScriptStatement.g:153:8: ~ ( '\\n' | '\\r' )
    ...
    mCOMMENT: function()  {
        try {
            ...
            switch (alt8) {
                case 1 :
                    // ../MmirScriptStatement.g:156:9: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
                    this.match("//"); 

                    // ../MmirScriptStatement.g:156:14: (~ ( '\\n' | '\\r' ) )*
                    loop4:
                    do {
                        var alt4=2;
                    ...
                    // ../MmirScriptStatement.g:156:28: ( '\\r' )?
                    var alt5=2;
                    ...
                    break;
                case 2 :
                    // ../MmirScriptStatement.g:157:9: '/*' ( options {greedy=false; } : . )* '*/'
                    this.match("/*"); 

                    // ../MmirScriptStatement.g:157:14: ( options {greedy=false; } : . )*
                    loop6:
                    do {
                        var alt6=2;
                    ...
                    break;
                case 3 :
                    // ../MmirScriptStatement.g:158:9: '@*' ( options {greedy=false; } : . )* '*@'
                    this.match("@*"); 

                    // ../MmirScriptStatement.g:158:14: ( options {greedy=false; } : . )*
                    loop7:
                    do {
                        var alt7=2;
    ...
    mSTRING: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // ../MmirScriptStatement.g:162:5: ( '\"' ( options {greedy=false; } : ( ESC_SEQ | ~ ( '\\\\' | '\"' ) ) )* '\"' )
            // ../MmirScriptStatement.g:162:8: '\"' ( options {greedy=false; } : ( ESC_SEQ | ~ ( '\\\\' | '\"' ) ) )* '\"'
            this.match('\"'); 
            // ../MmirScriptStatement.g:162:12: ( options {greedy=false; } : ( ESC_SEQ | ~ ( '\\\\' | '\"' ) ) )*
            loop10:
            do {
                var alt10=2;
                ...
                switch (alt10) {
                case 1 :
                    // ../MmirScriptStatement.g:162:39: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )
                    // ../MmirScriptStatement.g:162:39: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )
                    var alt9=2;
                    ...
                    switch (alt9) {
                        case 1 :
                            // ../MmirScriptStatement.g:162:40: ESC_SEQ
                            this.mESC_SEQ(); 


                            break;
                        case 2 :
                            // ../MmirScriptStatement.g:162:50: ~ ( '\\\\' | '\"' )
    ...
    mSSTRING: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // ../MmirScriptStatement.g:166:5: ( '\\'' ( options {greedy=false; } : ( ESC_SEQ | ~ ( '\\\\' | '\\'' ) ) )* '\\'' )
            // ../MmirScriptStatement.g:166:8: '\\'' ( options {greedy=false; } : ( ESC_SEQ | ~ ( '\\\\' | '\\'' ) ) )* '\\''
            this.match('\''); 
            // ../MmirScriptStatement.g:166:13: ( options {greedy=false; } : ( ESC_SEQ | ~ ( '\\\\' | '\\'' ) ) )*
            loop12:
            do {
                var alt12=2;
                ...
                switch (alt12) {
                case 1 :
                    // ../MmirScriptStatement.g:166:40: ( ESC_SEQ | ~ ( '\\\\' | '\\'' ) )
                    // ../MmirScriptStatement.g:166:40: ( ESC_SEQ | ~ ( '\\\\' | '\\'' ) )
                    var alt11=2;
                    ...
                    switch (alt11) {
                        case 1 :
                            // ../MmirScriptStatement.g:166:41: ESC_SEQ
                            this.mESC_SEQ(); 


                            break;
                        case 2 :
                            // ../MmirScriptStatement.g:166:51: ~ ( '\\\\' | '\\'' )
                            if ( (this.input.LA(1)>='\u0000' && this.input.LA(1)<='&')||(this.input.LA(1)>='(' && this.input.LA(1)<='[')||(this.input.LA(1)>=']' && this.input.LA(1)<='\uFFFF') ) {
                                this.input.consume();
    ...
    mHEX_DIGIT: function()  {
        try {
            // ../MmirScriptStatement.g:170:11: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // ../MmirScriptStatement.g:170:13: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
    ...
    mESC_SEQ: function()  {
        try {
            // ../MmirScriptStatement.g:174:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
            var alt13=3;
            ...
            switch (alt13) {
                case 1 :
                    // ../MmirScriptStatement.g:174:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
                    this.match('\\'); 
                    ...
                    break;
                case 2 :
                    // ../MmirScriptStatement.g:175:9: UNICODE_ESC
                    this.mUNICODE_ESC(); 


                    break;
                case 3 :
                    // ../MmirScriptStatement.g:176:9: OCTAL_ESC
                    this.mOCTAL_ESC(); 
    ...
    mOCTAL_ESC: function()  {
        try {
            // ../MmirScriptStatement.g:181:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            var alt14=3;
            ...
            switch (alt14) {
                case 1 :
                    // ../MmirScriptStatement.g:181:9: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // ../MmirScriptStatement.g:181:14: ( '0' .. '3' )
                    // ../MmirScriptStatement.g:181:15: '0' .. '3'
                    this.matchRange('0','3'); 



                    // ../MmirScriptStatement.g:181:25: ( '0' .. '7' )
                    // ../MmirScriptStatement.g:181:26: '0' .. '7'
                    this.matchRange('0','7'); 



                    // ../MmirScriptStatement.g:181:36: ( '0' .. '7' )
                    // ../MmirScriptStatement.g:181:37: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 2 :
                    // ../MmirScriptStatement.g:182:9: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
                    this.match('\\'); 
                    // ../MmirScriptStatement.g:182:14: ( '0' .. '7' )
                    // ../MmirScriptStatement.g:182:15: '0' .. '7'
                    this.matchRange('0','7'); 



                    // ../MmirScriptStatement.g:182:25: ( '0' .. '7' )
                    // ../MmirScriptStatement.g:182:26: '0' .. '7'
                    this.matchRange('0','7'); 
                    ...
                    break;
                case 3 :
                    // ../MmirScriptStatement.g:183:9: '\\\\' ( '0' .. '7' )
                    this.match('\\'); 
                    // ../MmirScriptStatement.g:183:14: ( '0' .. '7' )
                    // ../MmirScriptStatement.g:183:15: '0' .. '7'
                    this.matchRange('0','7'); 
    ...
    mUNICODE_ESC: function()  {
        try {
            // ../MmirScriptStatement.g:188:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
            // ../MmirScriptStatement.g:188:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
            this.match('\\'); 
            this.match('u'); 
            this.mHEX_DIGIT(); 
            this.mHEX_DIGIT(); 
    ...
    mTokens: function() {
        // ../MmirScriptStatement.g:1:8: ( T__30 | T__31 | DoEnterStatement | DoExitStatement | NL | WS | CHAR | COMMENT | STRING | SSTRING )
        var alt15=10;
        alt15 = this.dfa15.predict(this.input);
        switch (alt15) {
            case 1 :
                // ../MmirScriptStatement.g:1:10: T__30
                this.mT__30(); 


                break;
            case 2 :
                // ../MmirScriptStatement.g:1:16: T__31
                this.mT__31(); 


                break;
            case 3 :
                // ../MmirScriptStatement.g:1:22: DoEnterStatement
                this.mDoEnterStatement(); 


                break;
            case 4 :
                // ../MmirScriptStatement.g:1:39: DoExitStatement
                this.mDoExitStatement(); 


                break;
            case 5 :
                // ../MmirScriptStatement.g:1:55: NL
                this.mNL(); 


                break;
            case 6 :
                // ../MmirScriptStatement.g:1:58: WS
                this.mWS(); 


                break;
            case 7 :
                // ../MmirScriptStatement.g:1:61: CHAR
                this.mCHAR(); 


                break;
            case 8 :
                // ../MmirScriptStatement.g:1:66: COMMENT
                this.mCOMMENT(); 


                break;
            case 9 :
                // ../MmirScriptStatement.g:1:74: STRING
                this.mSTRING(); 


                break;
            case 10 :
                // ../MmirScriptStatement.g:1:81: SSTRING
                this.mSSTRING(); 
...
org.antlr.lang.extend(MmirScriptStatementLexer.DFA15, org.antlr.runtime.DFA, {
    getDescription: function() {
        return "1:1: Tokens : ( T__30 | T__31 | DoEnterStatement | DoExitStatement | NL | WS | CHAR | COMMENT | STRING | SSTRING );";
    },
        ...
        var retval = (function(s, input) {
            switch ( s ) {
                        ...
                        case 1 : 
                            ...
                            else if ( ((LA15_0>='\u0000' && LA15_0<='\b')||(LA15_0>='\u000B' && LA15_0<='\f')||(LA15_0>='\u000E' && LA15_0<='\u001F')||LA15_0=='!'||(LA15_0>='#' && LA15_0<='&')||LA15_0=='*'||(LA15_0>=',' && LA15_0<='.')||(LA15_0>='0' && LA15_0<='?')||(LA15_0>='A' && LA15_0<='z')||(LA15_0>='|' && LA15_0<='\u2027')||(LA15_0>='\u202A' && LA15_0<='\uFFFF')) ) {s = 15;}
