...
--><!-- assume initial states have been normalized --><stylesheet xmlns="http://www.w3.org/1999/XSL/Transform" xmlns:c="http://commons.apache.org/scxml-js" xmlns:s="http://www.w3.org/2005/07/scxml" version="1.0">
	...
	<template match="/">
		<variable name="states" select="//s:state[count(ancestor::*) &lt;= $maxDepth] |        //s:parallel[count(ancestor::*) &lt;= $maxDepth] |        //s:initial[count(ancestor::*) &lt;= $maxDepth]"/>
