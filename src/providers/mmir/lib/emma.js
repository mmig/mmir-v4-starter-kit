...
//			};
    ...
    _init: function(mmirCore){//WORKAROUND for "converting" mmir/requirejs impl. to node module-like
      mmirCore.emma = emmaUtils;
      extend = mmirCore.require('mmirf/util/extendDeep');
      return emmaUtils;
    }
	};
  ...
  if(typeof module === 'object' && module.exports){//WORKAROUND for "converting" mmir/requirejs impl. to node module-like
    module.exports = emmaUtils;
  }
