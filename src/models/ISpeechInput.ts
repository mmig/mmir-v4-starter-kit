...
export interface ISpeechFeedback {
   ...
   */
  startMicLevels(options: ShowSpeechStateOptions): void;
  /**
   ...
   *              the data specifying the (changed) speech input state etc.
   */
  stopMicLevels(options: ShowSpeechStateOptions): void;
...
export interface ReadingData {
  promptText?: string;//(general) system prompt that should be read to the user
